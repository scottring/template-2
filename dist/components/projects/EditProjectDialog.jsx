...
function EditProjectDialog({ project, open, onClose }) {
    const updateProject = (0, useProjectStore_1.useProjectStore)((state) => state.updateProject);
    ...
    const handleSubmit = (e) => __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            yield updateProject(project.id, formData);
            onClose();
        }
        catch (error) {
