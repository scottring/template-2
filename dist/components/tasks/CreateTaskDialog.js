...
exports.CreateTaskDialog = CreateTaskDialog;
const react_1 = require("react");
const react_2 = require("@headlessui/react");
const lucide_react_1 = require("lucide-react");
const useTaskStore_1 = require("@/lib/stores/useTaskStore");
function CreateTaskDialog({ projectId, goalId, open, onClose }) {
    const addTask = (0, useTaskStore_1.useTaskStore)((state) => state.addTask);
                    ...
                    <div className="mt-4">
                      <form onSubmit={handleSubmit} className="space-y-4">
                        ...
                        <div>
                          ...
                          <div className="mt-2">
                            <input type="date" name="dueDate" id="dueDate" required value={formData.dueDate.toISOString().split('T')[0]} onChange={(e) => setFormData((prev) => (Object.assign(Object.assign({}, prev), { dueDate: new Date(e.target.value) })))} className="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-blue-600 sm:text-sm sm:leading-6"/>
                          </div>
                        </div>
