...
exports.EditGoalDialog = EditGoalDialog;
const react_1 = require("react");
const react_2 = require("@headlessui/react");
const lucide_react_1 = require("lucide-react");
const useGoalStore_1 = require("@/lib/stores/useGoalStore");
function EditGoalDialog({ goal, open, onClose }) {
    const updateGoal = (0, useGoalStore_1.useGoalStore)((state) => state.updateGoal);
    ...
    const handleSubmit = (e) => __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            yield updateGoal(goal.id, Object.assign(Object.assign({}, formData), { successCriteria: formData.successCriteria.filter(Boolean) }));
            onClose();
        }
        catch (error) {
